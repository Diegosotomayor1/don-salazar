...
export function CoffeeTypeStep({
  ...
  const handleCoffeeSelect = (coffeeId: string) => {
    setUserData({ ...userData, coffeeType: coffeeId });
  };
      ...
      <Card className="luxury-card">
        ...
        <CardContent className="space-y-4">
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex flex-col items-center text-center space-y-2">
                      <span className="text-3xl">{coffee.icon}</span>
                      <div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Button
              onClick={nextStep}
              disabled={!userData.coffeeType}
              className="luxury-button flex-1 cursor-pointer"
            >
              {selectedCoffee?.requiresMilk ? "Elegir leche" : "Elegir tamaño"}
